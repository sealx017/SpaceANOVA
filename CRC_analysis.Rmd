...
Final_result = All_in_one(data = MIF_CRC, fixed_r = seq(0, 100, by = 10), Summary_function = "g", Hard_ths = 20, homogeneous = TRUE, interaction_adjustment = interaction_adjustment, perm = TRUE, cores = 8)

...
```{r P-value visualization,  out.width="40%"}
...
```{r plotting summary functions 1,  out.width="70%"}
...
```{r plotting summary functions 2,  out.width="70%"}
...
```{r plotting celluar organization,  out.width="70%"}
